...
#define ADC_DPL_ISR	    1	// for ADC INT 1 triggered ISR set as 1
...
#define EPWM4			1	// EPWM4 provides ISR trigger
#define EPWM5			1	// EPWM5 provides ISR trigger
...
#define EPWMn_DPL_ISR	1	// for EPWM triggered ISR set as 1
#define ADC_DPL_ISR	    1	// for ADC INT 1 triggered ISR set as 1
#define CLAn_DPL_ISR	1	// for CLA Task n Triggered ISR set as 1
...
#if (INCR_BUILD == 3) // which is combine ISR and CLA
#define EPWMn_DPL_ISR	1	// for EPWM triggered ISR set as 1
#define ADC_DPL_ISR	    1	// for ADC INT 1 triggered ISR set as 1
#define CLAn_DPL_ISR	1	// for CLA Task n Triggered ISR set as 1
